...
class model_abstract extends Model
{
    ...
    public function abstract_save($register_id,$abstract_site,$abstract_category,$main_author,$other_author,$alt_contact,$abstract_type,$title,$contant,$keywords,$comments)
    {

        $abstract_save = $this->db->prepare("INSERT INTO abstracts SET abstract_site=?, register_id=?, abstract_category=?, main_author=?, other_author=?, alt_contact=?, abstract_type=?, title=?,contant=?, keywords=?, comments=?");
    ...
    public function abstract_update($abstract_no,$register_id,$abstract_site,$abstract_category,$main_author,$other_author,$alt_contact,$abstract_type,$title,$contant,$keywords,$comments)
    {
        ...
        $abstract_update = $this->db->prepare("UPDATE abstracts SET abstract_site=?, register_id=?, abstract_category=?, main_author=?, other_author=?, alt_contact=?, abstract_type=?, title=?,contant=?, keywords=?, comments=? WHERE abstract_no=? ");
